...
HJY.directive("landmainDetails", function() {
    return {
        restrict: "ECMA",
        replace: true,
        templateUrl: "html/funpage_a/popum.html"
    }
})
HJY.directive("registerDownload", function() {
    return {
        restrict: "ECMA",
        replace: true,
        templateUrl: "html/funpage_a/download.html"
    }
})
HJY.directive("activePopum", function() {
    return {
        restrict: "ECMA",
        replace: true,
        templateUrl: "html/funpage_a/active/popum.html"
    }
})
HJY.directive("activeIcon", function() {
    return {
        restrict: "ECMA",
        replace: true,
        templateUrl: "html/funpage_a/active/icon.html"
    }
})